...
INSERT INTO public.settings (upvote_threshold, notification_radius_km) VALUES (1000, 5);
...
CREATE POLICY "Anyone can view resolution images" ON storage.objects FOR SELECT USING (bucket_id = 'resolution-images');
